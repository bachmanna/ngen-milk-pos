...
def settings_report():
  ...
  settings_keys = ["ANALYZER_TYPE","SCALE_TYPE","RATE_TYPE","COLLECTION_PRINTER_TYPE","MANUAL_FAT", "MANUAL_SNF", "MANUAL_QTY","PRINT_BILL","PRINT_CLR","PRINT_WATER", "BILL_OVERWRITE", "QUANTITY_2_DECIMAL","LANGUAGE","DATA_EXPORT_FORMAT", "SEND_SMS", "CAN_CAPACITY"]
